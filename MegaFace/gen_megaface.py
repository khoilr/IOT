...
def parse_arguments(argv):
    ...
    parser.add_argument(
        "--facescrub-root", type=str, help="", default="./data/facescrub_images"
    )
    parser.add_argument(
        "--megaface-root", type=str, help="", default="./data/megaface_images"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help="",
        default="GhostFaceNets/GhostFaceNet_W1.3_S1_ArcFace.h5",
    )
