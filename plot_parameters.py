...
if db == "agedb":
    ...
    nets = [
        ...
        "MobileFaceNets",
        "ShuffleFaceNet 0.5",
        "GhostFaceNet-2 (MS1MV3) (ours)",
        "GhostFaceNet-1 (MS1MV3) (ours)",
        "GhostFaceNet-2 (MS1MV2) (ours)",
        "GhostFaceNet-1 (MS1MV2) (ours)",
    ]
    marker = [
        "X",
        "2",
    ...
    flops = [1100, 1022, 933.3, 900, 577.5, 0.925, 0.99, 1.68, 1.75]
    nets = [
        "MobileFaceNetV1",
        "VarGFaceNet",
        "MobileFaceNet",
    ...
    accuracies = [87.17, 88.55, 89.22, 84.17, 88.50, 89.68, 89.63, 88.93, 90, 90.03]
    params = [3.4, 5.0, 2.0, 3.2, 2.6, 1.35, 0.925, 0.99, 1.68, 1.75]
    nets = [
        "MobileFaceNetV1",
        "VarGFaceNet",
        "MobileFaceNet",
    ...
    params = [4.5, 3.4, 5.0, 2.0, 3.2, 2.6, 1.35, 0.5, 0.925, 0.99, 1.68, 1.75]
    nets = [
        "ShuffleFaceNet 2x",
        "MobileFaceNetV1",
        "VarGFaceNet",
